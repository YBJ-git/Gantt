...
CREATE TABLE load_optimization_header (
    ...
    status NVARCHAR(20) NOT NULL DEFAULT 'PENDING', -- PENDING, APPLIED, REJECTED
...
CREATE TABLE load_optimization_detail (
    ...
    status NVARCHAR(20) NOT NULL DEFAULT 'PENDING', -- PENDING, APPLIED, REJECTED, MODIFIED
...
CREATE TABLE task_redistribution_detail (
    ...
    assignment_type NVARCHAR(20) NOT NULL, -- FIXED, SUGGESTED
    status NVARCHAR(20) NOT NULL DEFAULT 'PENDING', -- PENDING, APPLIED, REJECTED
...
CREATE TABLE redistribution_resource_stats (
    ...
    balance_status NVARCHAR(20) NOT NULL, -- BALANCED, UNBALANCED
